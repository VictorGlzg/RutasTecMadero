    ...
    fun basicResponses(_message:String) : String {
        ...
        return when {
            ...
            message.contains("hola") -> {
                "Hola, es un gusto atenderlo, escriba o diga la palabra comandos."
            }
            ...
            message.contains("comandos") || message.contains("comando") -> {
                "Los comandos son hola, ayuda, informacion, adios, direcciones"
            }
            else -> {
                "No entiendo la instrucción, intente escribir otra opción (comandos)."
            }
        }
    }
}